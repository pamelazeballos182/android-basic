package com.example.zeballos.memoryapplication;
...
public class MainActivity extends Activity {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_main); // Set the content view to main which is the app's main layout.
         ...
         * updated.
         */
        private View.OnClickListener cardClickedListener = new View.OnClickListener() {
            /**
